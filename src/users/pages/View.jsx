            ...
            <div className="shadow border p-5 border-gray-200">
                <div className="md:grid grid-cols-4 gap-x-10">
                    ...
                    <div className="col-span-1">
                        <img className='w-full' src="https://cdn2.penguin.com.au/covers/original/9781786330895.jpg" alt="book" />
                    </div>
                    {/* book details column */}
                    <div className="col-span-3">
                        ...
                        <div className="md:my-10 my-4">
                            <p className='font-bold text-lg'>Abstract Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda deleniti praesentium eius quam, perspiciatis sit asperiores facilis molestiae vel exercitationem quibusdam, sequi nobis autem sint amet ut? Fugit, corporis aliquam?</p>
                        </div>
            ...
            <div className="flex justify-center items-center min-h-screen">
                <div className="bg-white rounded-2xl md:w-250 w-100">
                    ...
                    <div className="relative p-5">
                        <p className='text-blue-600 flex items-center'><FaCamera className='me-2'/>Camera clicks of book in the hand of seller</p>
                        {/* book images in row */}
                        <div className="md:flex flex-wrap my-4">
                            <img className='md:w-75 w-25 md:me-2 mb-3 md:mb-0' src="https://cdn2.penguin.com.au/covers/original/9781786330895.jpg" alt="book" />
                        </div>
                    </div>
                </div>
            </div>
